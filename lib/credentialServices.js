...
const API_BASE_URL = (process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:3001').replace(/\/$/, '');
...
export function getCredentialDisplayInfo(credential) {
  ...
  const icons = {
    BANK_BALANCE_HIGH: 'Coins',
    BANK_BALANCE_MEDIUM: 'Coins',
    BANK_BALANCE_LOW: 'Coins',
    BANK_BALANCE_MINIMAL: 'Coins',
    INCOME_HIGH: 'Briefcase',
    INCOME_MEDIUM: 'Briefcase',
    INCOME_LOW: 'Briefcase',
    INCOME_MINIMAL: 'Briefcase',
    CEX_HISTORY: 'TrendingUp',
